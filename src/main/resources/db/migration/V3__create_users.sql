...
(
    ...
    tenant_id     uuid        NOT NULL
        CONSTRAINT fk_users_tenants REFERENCES tenants (id),
    email         text        NOT NULL,
    password_hash text        NOT NULL,
    full_name     text        NOT NULL,
    role          text        NOT NULL
        CONSTRAINT chk_users_role CHECK (role IN ('REQUESTOR', 'AGENT', 'MANAGER', 'ADMIN')),
    team_id       uuid        NULL
        CONSTRAINT fk_users_teams REFERENCES teams (id),
