...
CREATE INDEX idx_auth_sessions_tenant_id_refresh_token_hash_active ON auth_sessions (tenant_id, refresh_token_hash) WHERE revoked_at IS NULL AND expires_at > now();
